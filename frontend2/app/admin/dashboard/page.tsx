  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Dobrodošli Nazad! Analitika vašeg poslovanja.</p>
      </div>
            ...
            <div className="space-y-4 flex flex-col items-center"> 
              ...
              <div className="w-full">
                {stats.topSellingEvents.map((event: any, i: number) => (
                  <div key={i} className="flex items-center justify-between p-4 mb-3 rounded-lg border border-slate-100 hover:bg-slate-50 transition-colors w-full">
